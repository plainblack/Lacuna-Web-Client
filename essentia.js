...
(function(){
	...
	Essentia.prototype = {
		_getHtml : function() {
			...
			'				<li class="essentiaDetailsImg"><img src="',Lib.AssetUrl,'ui/s/food.png" /></li>',
			'				<li class="essentiaDetailsCost">5<img src="',Lib.AssetUrl,'ui/s/essentia.png" /></li>',
			...
			'			</ul>',
			'			<ul class="essentiaBoosts clearafter">',
			'				<li class="essentiaDetailsImg"><img src="',Lib.AssetUrl,'ui/s/ore.png" /></li>',
			'				<li class="essentiaDetailsCost">5<img src="',Lib.AssetUrl,'ui/s/essentia.png" /></li>',
			...
			'			</ul>',
			'			<ul class="essentiaBoosts clearafter">',
			'				<li class="essentiaDetailsImg"><img src="',Lib.AssetUrl,'ui/s/water.png" /></li>',
			'				<li class="essentiaDetailsCost">5<img src="',Lib.AssetUrl,'ui/s/essentia.png" /></li>',
			...
			'			</ul>',
			'			<ul class="essentiaBoosts clearafter">',
			'				<li class="essentiaDetailsImg"><img src="',Lib.AssetUrl,'ui/s/energy.png" /></li>',
			'				<li class="essentiaDetailsCost">5<img src="',Lib.AssetUrl,'ui/s/essentia.png" /></li>',
			...
			'			</ul>',
			'			<ul class="essentiaBoosts clearafter">',
			'				<li class="essentiaDetailsImg"><img src="',Lib.AssetUrl,'ui/s/happiness.png" /></li>',
			'				<li class="essentiaDetailsCost">5<img src="',Lib.AssetUrl,'ui/s/essentia.png" /></li>',

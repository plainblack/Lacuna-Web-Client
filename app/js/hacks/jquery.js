...
// NOTE: this is a copy of the Semantic UI js file with some changes made so that it uses
// node-style exporting so it can be used in the rest of the project.

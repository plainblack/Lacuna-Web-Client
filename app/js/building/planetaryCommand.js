    ...
    Lang.extend(PlanetaryCommand, Lacuna.buildings.Building, {
        ...
        _getPlanetTab : function() {
            ...
            var tab = new YAHOO.widget.Tab({ label: "Planet", content: [
                    ...
                    '            <li title="',Lib.formatNumber(this.result.next_colony_srcs),'"><label>Next SRCS Cost:</label>',Lib.convertNumDisplay(this.result.next_colony_srcs),'<span class="smallImg"><img src="',Lib.AssetUrl,'ui/s/happiness.png" /></span></li>',
                    ...
                    '            <li title="',Lib.formatNumber(this.result.insurrect_value),'"><label>Insurrect Target Value:</label>',Lib.convertNumDisplay(this.result.insurrect_value),'<span class="smallImg"><img src="',Lib.AssetUrl,'ui/s/happiness.png" /></span></li>',

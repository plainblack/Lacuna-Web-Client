		...
		_buildBuilderPanel : function() {
			...
			this.buildingBuilder.updateDisplay = function() {
				...
				for(var i=0; i<names.length; i++) {
					...
					'			<span><span><img src="',Lib.AssetUrl,'ui/s/food.png" title="Food" class="smallFood" /></span><span>',costs.food,'</span></span>',
					'			<span><span><img src="',Lib.AssetUrl,'ui/s/ore.png" title="Ore" class="smallOre"  /></span><span>',costs.ore,'</span></span>',
					'			<span><span><img src="',Lib.AssetUrl,'ui/s/water.png" title="Water" class="smallWater" /></span><span>',costs.water,'</span></span>',
					'			<span><span><img src="',Lib.AssetUrl,'ui/s/energy.png" title="Energy" class="smallEnergy" /></span><span>',costs.energy,'</span></span>',
					'			<span><span><img src="',Lib.AssetUrl,'ui/s/waste.png" title="Waste" class="smallWaste" /></span><span>',costs.waste,'</span></span>',
					'			<span><span><img src="',Lib.AssetUrl,'ui/s/time.png" title="Time" class="smallTime" /></span>',Lib.formatTime(costs.time),'</span>',
					'		</div>',
					'		<div><label style="font-weight:bold;">Prod:</label>',
					'			<span><span><img src="',Lib.AssetUrl,'ui/s/food.png" title="Food" class="smallFood" /></span><span>',prod.food_hour,'/hr</span></span>',
					'			<span><span><img src="',Lib.AssetUrl,'ui/s/ore.png" title="Ore" class="smallOre"  /></span><span>',prod.ore_hour,'/hr</span></span>',
					'			<span><span><img src="',Lib.AssetUrl,'ui/s/water.png" title="Water" class="smallWater" /></span><span>',prod.water_hour,'/hr</span></span>',
					'			<span><span><img src="',Lib.AssetUrl,'ui/s/energy.png" title="Energy" class="smallEnergy" /></span><span>',prod.energy_hour,'/hr</span></span>',
					'			<span><span><img src="',Lib.AssetUrl,'ui/s/waste.png" title="Waste" class="smallWaste" /></span><span>',prod.waste_hour,'/hr</span></span>',
					'			<span><span><img src="',Lib.AssetUrl,'ui/s/happiness.png" title="Happiness" class="smallHappy" /></span><span>',prod.happiness_hour,'/hr</span></span>',
					'		</div>',
					'	</div>',

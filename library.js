...
(function(){
	...
	var Library = {
		...
		Descriptions : {
			...
			"/apple" : "Allows you to grow apples to feed your empire.  You can only grow apples in orbit 3 (it's goldilox zone).  Food production increases for every level of the orchard.  All plants need a source of phosphorus to photosynthesize their food. Therefore you need a good source of gypsum, sulfur, or monazite for plants to thrive.",
			"/archaeology" : "Allows you to search through specific types of ore to find Glyphs.",
			"/bean" : "The Amalgus Bean Plantation allows you to grow beans to be used as food by your empire.  You can only grow beans in orbit 4 (it's goldilox zone).  The higher the level of the plantation the more food it produces.  All plants need a source of phosphorus to photosynthesize their food. Therefore you need a good source of gypsum, sulfur, or monazite for plants to thrive.", //"Amalgus Bean Plantation"
			...
			"/dairy" : "The Dairy Farm allows you to produce food via dairy cattle.  It can only be used in orbit 3 (it's goldilox zone).  The higher the level of farm the more food it produces. Cows require certain minerals in their diet in order to produce lots of high quality milk. Therefore in order to have a dairy farm you're going to need a good supply of trona.",
			"/denton" : "The Denton Root Patch produces roots to be used as food by your empire.  The roots only grow in orbit 5 (it's goldilox zone).  The higher the level of the patch the more food it produces.  All plants need a source of phosphorus to photosynthesize their food. Therefore you need a good source of gypsum, sulfur, or monazite for plants to thrive.", //"Denton Root Patch"
			...
			"/lapis" : "The Lapis Orchard produces lapis to be used as food by your empire.  Lapis can only be grown in orbit 2 (it's goldilox zone).  The higher the level of the orchard the more food it produces.  All plants need a source of phosphorus to photosynthesize their food. Therefore you need a good source of gypsum, sulfur, or monazite for plants to thrive.",
			...
			"/potato" : "The Potato Patch allows you to grow potatoes to be used as food for you empire.  The patch can only be used in orbits 3 and 4 (it's goldilox zone).  The higher the level of the patch the more food it produces.  All plants need a source of phosphorus to photosynthesize their food. Therefore you need a good source of gypsum, sulfur, or monazite for plants to thrive.",

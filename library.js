...
(function(){
	...
	var Library = {
		...
		Descriptions : {
			...
			"/burger" : "The Burger Packer converts fungus from the Malcud Fungus Farm and produces burgers, at a small loss, to food.  The higher the building level the more  food is converted.",
			...
			"/chip" : "The Denton Root Chip Frier converts roots from the Denton Root Farm and turns it into root chips as food for your empire at a minimal loss.  The higher the level of the Chip Frier the more food it converts.",
			...
			"/oversight" : "The Oversight Ministry reduces the amount of time buildings take to upgrade through better project management. All buildings will be produced 3% faster per level of the Oversight Ministry.",

...
(function(){
	...
	var Library = {
		...
		Descriptions : {
			...
			"/apple" : "Allows you to grow apples to feed your empire.  You can only grow apples in orbit 3 (it's goldilox zone).  Food production increases for every level of the orchard.",
			"/bean" : "The Amalgus Bean Plantation allows you to grow beans to be used as food by your empire.  You can only grow beans in orbit 4 (it's goldilox zone).  The higher the level of the plantation the more food it produces.", //"Amalgus Bean Plantation"
			"/beeldeban" : "The Beeldeban Herder allows the raising of beeldeban to be used as food for your empire.  It can only be built in orbits 2, 3, and 4 (it's goldilox zone).  The higher the building level the more food is produced.",
			...
			"/corn" : "The Corn Plantation produces corn to be used as food by your empire.  The corn plantation can only be used in orbits 2 and 3.  The higher the level of the plantation the more food is produced.",
			...
			"/dairy" : "The Dairy Farm allows you to produce food via dairy cattle.  It can only be used in orbit 3 (it's goldilox zone).  The higher the level of farm the more  food it produces.",
			"/denton" : "The Denton Root Patch produces roots to be used as food by your empire.  The roots only grow in orbit 5 (it's goldilox zone).  The higher the level of the patch the more  food it produces.", //"Denton Root Patch"
			...
			"/fission" : "The Fission Energy  Plant produces energy  by splitting atoms.  This way of producing energy is very efficient on an waste  per energy produced ratio.  The higher the building level the more energy is produced.",
			"/fusion" : "The Fusion Energy  Plant produces energy  by fusing atoms together.  This type of energy is even more efficient than the Fission Energy Plant on a waster per energy produced ratio.  Requires a high level University to construct.  The higher the building level the more energy is produced. ",
			...
			"/hydrocarbon" : "The Hydrocarbon Energy  Plant produces large amounts of energy at the cost of producing large amounts of waste by burning hydrocarbons.  It also uses significant amounts of ore in the production of this energy.  The higher the building level the more energy is produced.  ",
			...
			"/lapis" : "The Lapis Orchard produces lapis to be used as food by your empire.  Lapis can only be grown in orbit 2 (it's goldilox zone).  The higher the level of the orchard the more food it produces.",
			...
			"/orerefinery" : "The Ore Refinery increases the amount of ore  extracted from each mine  by purifying the ore  and producing less waste.  The higher the refinery level the higher the purification process and even greater amounts of ore  are extracted from the mine.",
			...
			"/potato" : "The Potato Patch allows you to grow potatoes to be used as food for you empire.  The patch can only be used in orbits 3 and 4 (it's goldilox zone).  The higher the level of the patch the more food it produces.",
			"/propulsion" : "Work done in the Propulsion System Factory allows your ships to move faster through space by way of upgraded engines.  The higher the building level the faster your ships move.  All ships originating from this planet are affected.",
			"/rnd" : "The Research Lab is the place where you can report bugs and ask for new features to be added to the Lacuna Expanse.  It is your channel to the developers of the game.  The Laboratory is also a good source of happiness for your citizens.  The higher the level of the building the more happiness it produces.  ",

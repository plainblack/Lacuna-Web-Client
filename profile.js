...
(function(){
	...
	Profile.prototype = {
		_getHtml : function() {
			...
			'									<li><input id="profileSkipAttackMessages" type="checkbox" /> Stop Attack Messages</li></ul>',
            '                                   <li><input id="profileSkipIncomingShips" type="checkbox" /> Stop Incoming Ships Messages</li></ul>',
'</div>',
			'								<div class="yui-u">',
